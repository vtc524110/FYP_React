...
import SellerItem from "components/SellerItem.js"
import {
    Button,
    Container,
    Row,
    ...
    fetchBiddings = () => {
        axios.get("http://desmond.business:8080/fyp/getBiddings")
            .then(res => {
                ...
                posts.forEach((elm) => {
                    if (elm.seller_customer_id == this.props.seller_customer_id) {
        ...
        if (this.state.loading) {
            return (
                ...
                <div className="section">
                    ...
                    <Route exact path="/History/:id" render={(props) => {
                        const id = props.match.params.id;
                        return <SellerItem id={id}{...props} />
                    }} />
